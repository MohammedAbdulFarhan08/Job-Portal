        ...
        <div class="row">
          <div class="col-lg-8">
            ...
            <?php if(isset($_SESSION['username'])) : ?>
              <?php if(isset($_SESSION['type']) AND $_SESSION['type'] == "Worker") : ?>
                ...
                <?php endif; ?>
            <?php else : ?>
              <h2>Please login to proceed with your application </h2>
            <?php endif; ?>  
          ...
          <div class="col-lg-4">
            ...
            <div class="bg-light p-3 border rounded">
              ...
              <div class="px-3">
                <a href="https://www.facebook.com/sharer/sharer.php?u=https://localhost:8080/jobboard/jobs/job-single.php?id=<?php echo $row->id; ?>&quote=<?php echo $row->job_title; ?>" class="pt-3 pb-3 pr-3 pl-0"><span class="icon-facebook"></span></a>
