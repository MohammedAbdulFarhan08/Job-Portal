          ...
          <div class="col-md-7">
            <div class="card p-3 py-4">
                    ...
                    <div class="text-center mt-3">
                        ...
                        <div class="px-3">
                            <a target="_blank" href="<?php echo $profile->facebook; ?>" class="pt-3 pb-3 pr-3 pl-0 underline-none"><span class="icon-facebook"></span></a>
                            <a target="_blank" href="<?php echo $profile->x; ?>" class="pt-3 pb-3 pr-3 pl-0"><span class="icon-twitter"></span></a>
                            <a target="_blank" href="<?php echo $profile->linkedin; ?>" class="pt-3 pb-3 pr-3 pl-0"><span class="icon-linkedin"></span></a>
                        </div>
