        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-12">
            <div class="mb-5 text-center">
              ...
              <p>Chase your dreams and pursue personal growth with unwavering dedication.</p>
            </div>
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-7 text-center">
            ...
            <p class="lead text-white">Chase your dreams and pursue personal growth with unwavering dedication.</p>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-8">
            ...
            <p class="mb-0 text-white lead">Every job search is a journey towards a new opportunity—keep moving forward with confidence.</p>
          </div>
          <div class="col-md-3 ml-auto">
            <a href="http://localhost:8080/jobboard/auth/register.php" class="btn btn-warning btn-block btn-lg">Sign Up</a>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="col-12 text-center mt-4 mb-5">
            <div class="row justify-content-center">
              <div class="col-md-7">
                ...
                <p class="lead">Helping businesses thrive isn’t just our mission; it’s our proudest accomplishment.</p>
              </div>
            </div>
        ...
        <div class="owl-carousel single-carousel">
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-6 align-self-center text-center text-lg-left">
                <blockquote>
                  <p>&ldquo;A solution almost as if by choice, easy to reject, unaware of the troubles of accusing freedom, pains of repelling, and the responsibility in the problem, to the extent of changes or modifications that address or disregard the pains, the satisfaction, and the pleasure of rejection.&rdquo;</p>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-6 align-self-center text-center text-lg-left">
                <blockquote>
                  <p>&ldquo;A solution, seemingly chosen, may be easily rejected without understanding the challenges of freedom from accusations, the associated pains, or the need for adjustments in response to suffering and pleasure.&rdquo;</p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 align-self-center text-center text-md-left mb-5 mb-md-0">
            ...
            <p class="mb-5 lead text-white">Chase your dreams and pursue personal growth with unwavering dedication..</p>
            <p class="mb-0">
